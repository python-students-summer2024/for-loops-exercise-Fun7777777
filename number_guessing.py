...
def guess_number(low, high, num_attempts):
    ...
    print(f"I'm thinking of a number between {low} and {high}. You have {num_attempts} attempts.")
    ...
    print(f"Sorry, you've used all {num_attempts} attempts. The correct number was {secret_number}.")
    return False
